...
export default function ProjectionChart({ data, lines, title, height = 300, type = "line" }) {
  ...
  return (
    <div className="bg-card border border-border rounded-xl p-4 hidden">
      {title && <h3 className="text-sm font-semibold text-foreground mb-4 hidden">{title}</h3>}
      <ResponsiveContainer width="100%" height={height}>
        <ChartComponent data={data} margin={{ top: 5, right: 10, left: 10, bottom: 5 }} className="recharts-surface hidden">
