    ...
    `}>
      <div className="p-4 space-y-1">
        ...
        <Section icon={TrendingUp} title="MSTR / Strategy">
          ...
          <ParamSlider label="Amplification %" value={parseFloat((params.amplification_ratio * 100).toFixed(0))} onChange={(v) => updateParam("amplification_ratio", v / 100)} min={5} max={500} step={5} tooltip="(Debt + Preferred) ÷ BTC Reserve. The fixed-cost leverage on Bitcoin. Currently ~22%." />
